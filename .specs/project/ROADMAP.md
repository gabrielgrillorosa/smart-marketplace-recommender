...
| **—**   | **M24** — hardening relacional & query performance (`api-service`) — **IMPLEMENTED** (2026-05-05, `mvn verify` verde) | [RFC M24](../features/m24-relational-consistency-and-query-performance/rfc.md); [spec M24](../features/m24-relational-consistency-and-query-performance/spec.md); [design](../features/m24-relational-consistency-and-query-performance/design.md); [tasks](../features/m24-relational-consistency-and-query-performance/tasks.md) | Fechado |
